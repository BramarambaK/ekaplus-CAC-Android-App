...
import com.eka.cacapp.data.insight.InsightSortFilterData
import com.eka.cacapp.data.qtcLayout.FilterItem
import com.eka.cacapp.utils.Constants
import com.google.android.material.bottomsheet.BottomSheetDialog

class InsightDtlSortAdapter(private val context: Context, private val itemList: ArrayList<InsightSortFilterData>,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        convertView = LayoutInflater.from(context).inflate(R.layout.insight_sort_row, parent, false)
