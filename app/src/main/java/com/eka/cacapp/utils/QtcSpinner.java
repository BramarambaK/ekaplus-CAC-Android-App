 ...
 *
 */
public class QtcSpinner extends Spinner {
    ...
    public QtcSpinner(Context context) {
        super(context);
        setup();
    }

    public QtcSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup();
    }

    public QtcSpinner(Context context, int mode) {
        super(context, mode);
        setup();
    }

    private void setup() {
        QtcSpinner.this.setOnItemSelectedListener(null);
    }
